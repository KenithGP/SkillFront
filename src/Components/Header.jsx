                ...
                {!isAuthenticated ? (
                    ...
                    <>
                        <div className="flex items-center space-x-4">
                            ...
                            {/* Racha */}
                            <div className="text-white text-lg flex items-center space-x-2 w-logros ">
                                <i className="fa fa-trophy text-yellow-500 p-2"></i>
                                <span className="text-yellow-500 font-bold  flex-1 text-center invisible-pre-1300">{racha}</span>
                            </div>
                            ...
                            <div className="relative">
                                ...
                                >
                                    ...
                                    <span className="invisible-pre-1300">Anthony Atiro</span>
                                </button>
                                {showProfile && (
